...
--- User signup
insert into settings( sg_name, s_name, s_type, s_value, s_fullname, s_description )
values( 'odin_generic', 'odin_site_url', 'text', 'http://localhost', 'Odin URL', 'FQDN for where Odin is hosted' );
insert into settings( sg_name, s_name, s_type, s_value, s_fullname, s_description )
values( 'odin_generic', 'system_operator', 'text', '', 'Name of system operator', 'For legal reasons the name of the organisation/individual operating Odin should be supplied here. Will be visible in the "Terms and Conditions" document.' );
insert into settings( sg_name, s_name, s_type, s_value, s_fullname, s_description )
values( 'odin_generic', 'country', 'text', '', 'Country', 'This should be the country under wich laws Odin should be operated under. Typically the same as the servers or organisation/individual above is located in. Will be visible in the "Terms and Conditions" document.' );
insert into settings( sg_name, s_name, s_type, s_value, s_fullname, s_description )
values( 'odin_generic', 'contact_mail', 'email', '', 'Contact e-mail', 'Will be visible under sections "About" and "Terms and Conditions". Intended for general questions about your operation of Odin.' );
insert into settings( sg_name, s_name, s_type, s_value, s_fullname, s_description )
...
insert into settings( sg_name, s_name, s_type, s_value, s_fullname, s_description )
values( 'hosts', 'host_expiry_warning_interval', 'number', '7', 'Host expiry warning interval (days)', 'How often notification emails are sent to user about expiring leases.' );
insert into settings( sg_name, s_name, s_type, s_value, s_fullname, s_description )
